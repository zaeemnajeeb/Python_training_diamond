...
print( f20(1,2) )  # prints 20 + 1 + 2 - ALREADY KNOWS x = 20
print( f20(7,9) )  # prints 20 + 7 + 9 - ALREADY KNOWS x = 20
print( f50(1,2) )  # prints 50 + 1 + 2 - ALREADY KNOWS x = 50
print( f50(7,9) )  # prints 50 + 7 + 9 - ALREADY KNOWS x = 50
